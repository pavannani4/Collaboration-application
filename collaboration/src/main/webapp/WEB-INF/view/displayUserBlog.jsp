...
<div ng-repeat="c in ubgls | filter:na">
 ...
 <!--<div class="col-sm-2 pull-right">
      ...
      <div class="span5">
         <div class="spanAddress">
			<address>
				<strong>Blog title:</strong> <span>{{c.btitle}}</span><br>
				<strong>Description:</strong> <span>{{c.busername}}{{c.blogid}}</span><br>
				<strong>Tags:</strong> <span>{{c.btag}}</span><br>
				</address>
				</div>
				</div>
      </div>--> 
 ...
 <!--   <div class="alert alert-info">
  <div class="row">
    ...
    <a href="mail" class="btn btn-info btn-md">Email</a>
